package com.example.testapp.scrapers;
...
import com.example.testapp.generics.Aggregator;
 ...
 */
public class Kickass extends Aggregator {
     ...
     */
    public Kickass(Trend objContext) {
